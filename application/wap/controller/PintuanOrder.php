...
class PintuanOrder extends Order
{
	...
	public function paymentOrder()
	{
		...
		return $this->view($this->style . 'Order/paymentOrder');
	}
...
//		$member_price = $goods_preference->getGoodsSkuMemberPrice($sku_info['sku_id'], $this->uid);
	...
	{
		$this->assign("title", lang('spell_group_order'));
		$this->assign("title_before", lang('spell_group_order'));
		return $this->view($this->style . 'PintuanOrder/myOrderList');
	}
	...
	public function mySpellingOrderList()
	{
		...
		return $this->view($this->style . 'PintuanOrder/mySpellingOrderList');
	}
	...
	public function orderDetail()
	{
		...
		return $this->view($this->style . 'PintuanOrder/orderDetail');
	}
	...
	public function spellGroupShare()
	{
		...
		return $this->view($this->style . 'PintuanOrder/spellGroupShare');
	}
}