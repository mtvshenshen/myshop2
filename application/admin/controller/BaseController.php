...
class BaseController extends Controller
{
	...
	public function init()
	{
		...
		if ($check_auth) {
			...
			if (!request()->isAjax()) {
				...
				$root_module_info = $this->website->getSystemModuleInfo($this->rootid, 'module,module_name,url,module_picture');
				...
				$this->user_headimg = $this->user->getSessionUserHeadImg();
	...
	/**
	 * 上传到相册
	 * @return \boolean[][]|\data\service\Ambigous|\data\service\Ambigous[][]|\data\service\unknown[][]|number[]|\number[][]|\string[][]
	 */
	...
	/**
	 * 视频上传
	 * @return \data\service\unknown|\data\service\unknown[][]|NULL[]|number[]|\number[][]|string|string[]|\string[][]
	 */
