...
$(function(){
	...
	$("#is_default").change(function(){
		...
		if(parseInt($(this).val())){
			//默认地区不需要选中地区
			$(".js-select-city").text("默认地区(全国)").attr("data-flag",1).addClass("btn-gradient-default").removeClass("btn-gradient-blue");
			...
			$(".js-select-city").addClass("btn-gradient-blue").removeClass("btn-gradient-default").text("指定地区城市").attr("data-flag",0);
		}
	});
