	...
	vue = new Vue({
		...
		data: {
			data : [
					...
					{ tag : "spell-group" , name: "拼团推荐", className: "item-spell-group",index : 8, sort: 8, selected: false, isVisible: true, url : '/tuangou/pintuanlist' },
					{ tag : "adv" , name: "广告位", className: "item-adv",index : 9, sort: 9, selected: false, isVisible: true, url : '/system/shopadvpositionlist?terminal=2' },
					{ tag : "goods" , name: "推荐商品", className: "item-goods",index : 10, sort: 10, selected: false, isVisible: true, url : '/config/goodsRecommend' },
					{ tag : "cube" , name: "魔方", className: "item-cube",index : 11, sort: 11, selected: false, isVisible: true, url : '/config/shopCube'},
					{ tag : "bottom" , name: "底部导航", className: "item-bottom",index : 12, sort: 12, selected: false, isVisible: true, url : ''},
				],

			//重置
			rest : ["follow-wechat","banner","search","nav","notice","coupons","games","discount","spell-group","adv","goods","cube","bottom"],
			...
			clickModule: function (index) {
				...
				var html = '<div class="edit-wrap">' +
								'<div class="item-title">'+
									...
									'<a href="'+(vue.current.url ? ADMINMAIN+'/'+vue.current.url : "")+'" target=_black>设置</a>' +
								'</div>'+
								'<div class="item">' +
									'<label>是否显示</label>' +
