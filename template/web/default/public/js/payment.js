...
$(function(){
	...
	$('.address-cont li .addr-name').click(function(event) {
		...
		$(this).parents('li').siblings('li').removeClass('active').find('.addr-name').removeClass('ns-border-color');
	...
	$('.shipping-type-cont li').click(function(event) {
		...
		$(this).addClass('active ns-border-color').siblings('li').removeClass('active ns-border-color');
	...
	$(".coupon-list .coupon-item").click(function(){
		if($(this).hasClass('active')){
			...
			$(this).addClass('active ns-border-color').siblings('.coupon-item').removeClass('active ns-border-color');
			if($(".discount-info .info").length == 1){
				$(".discount-info").show();
			}else{
