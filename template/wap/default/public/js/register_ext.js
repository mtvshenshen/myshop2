var lang = {};
$(function(){
	langApi(["password_cannot_empty","password_must_contain_symbols","password_must_have_uppercase_letters","password_must_have_lowercase_letters","user_name_canno_be_mailbox","password_must_contain_numbers","password_cannot_includ_chinese_characters","minimum_password_length","such_characters","username_cannot_includ","user_name_canno_be_phone","user_name_cannot_contain_chinese_characters","confirm_password_can_not_be_empty","verification_code_cannot_be_null","two_password_input_is_inconsistent",],function(res){
		lang = res;
	});
});
