...
$(function () {
    $("#list li").click(function () {
        ...
        if (title == lang_member_info.password) {
            ...
            $("#divInfo").toggle();
            $("#exit").toggle();
            $("#value").attr("placeholder", lang_member_info.please_enter_the_mailbox);
            $("#input_ico").attr("src", WAPIMG+"/center_email.png");
        } else {
            $(".ns-header h1").html(title);
            $("#value").val(value);
            $("#saveBtn,#logoutBtn").toggle();
            ...
            if (title == lang_member_info.member_real_name) {
                $("#value").attr("placeholder", lang_member_info.member_enter_your_real_name);
                $("#input_ico").attr("src", WAPIMG+"/center_user.png");
            } else if (title == "QQ{:lang_member_info('')}") {
                $("#value").attr("placeholder", lang_member_info.please_enter_qq_number);
                $("#input_ico").attr("src", WAPIMG+"/center_qq.png");
            } else if (title == lang_member_info.wechat) {
                $("#value").attr("placeholder", lang_member_info.please_enter_a_micro_signal);
                $("#input_ico").attr("src", WAPIMG+"/center_weixn.png");
            }
        }
    });
});
