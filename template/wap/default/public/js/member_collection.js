        ...
        if(data['data'].length > 0){
            for (var i = 0; i < data['data'].length; i++) {
                ...
                if(item['goods_id'] != "" && item['goods_id'] != null){
                    ...
                    html += '<div class="goods-info fav_id_'+item['fav_id']+'">';
                    ...
                    html += '<img src="'+__IMG(item.pic_cover_mid)+'" alt="" class="pic"  onerror=' + empty + '>';
                    html += '</div>';
...
function FavoritesGoodsIsEmpty(){
    ...
    if(favoritesGoodsNum == 0){
        var html = '<div class="collection-goods-empty">';
        html += '您还没有收藏记录';
        html += '</div>';
        $(".collection-goods-list").html(html);
    }
