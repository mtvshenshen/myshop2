...
//             'homepage_pictures' => $homepage_pictures
	...
	{
		// TODO Auto-generated method stub
		$cache = Cache::tag("niu_goods_category")->get("getGoodsCategoryBlock" . $shop_id);
		if (empty($cache)) {
			$goods_category_block = new NsGoodsCategoryBlockModel();
			$goods_category_block_query = $goods_category_block->getQuery([
				"shop_id" => $shop_id
			], "*", "sort asc");
			Cache::tag("niu_goods_category")->set("getGoodsCategoryBlock" . $shop_id, $goods_category_block_query);
	...
	{
		$cache = Cache::tag("niu_goods_category")->get("getGoodsCategoryBlockList" . $shop_id);
		if (empty($cache)) {
			$goods_category_block = new NsGoodsCategoryBlockModel();
			...
			Cache::tag("niu_goods_category")->set("getGoodsCategoryBlockList" . $shop_id, $goods_category_block_list, 1800); // 缓存半小时
	...
	{
		$cache = Cache::tag("niu_goods_category")->get("getGoodsCategoryBlockQuery" . $shop_id . '_' . $show_num);
		if (empty($cache)) {
			$goods_category_block = new NsGoodsCategoryBlockModel();
			$goods = new Goods();
			$goods_category_block_list = $goods_category_block->getQuery([
			...
			Cache::tag("niu_goods_category")->set("getGoodsCategoryBlockQuery" . $shop_id . '_' . $show_num, $goods_category_block_list, 1800); // 缓存半小时
			return $goods_category_block_list;
		} else {
			return $cache;
		}
