...
class WeixinMessage extends BaseService
{
	...
	{
		$cache = Cache::tag('weixin_message')->get('getMessageInfo' . '_' . $template_no . '_' . $instance_id);
		...
		Cache::tag('weixin_message')->set('getMessageInfo' . '_' . $template_no . '_' . $instance_id, $message);
	...
	{
		$cache = Cache::tag('weixin_message')->get('getWeixinInstanceMsg' . $instance_id);
		if (!empty($cache)) return $cache;
		...
		Cache::tag('weixin_message')->set('getWeixinInstanceMsg' . $instance_id, $message);
		return $message;
