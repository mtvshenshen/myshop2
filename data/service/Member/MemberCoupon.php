...
class MemberCoupon extends BaseService
{
    ...
    public function getUserCouponList($type = '', $shop_id = '')
    {
        ...
        ->field('nc.coupon_id, nc.coupon_code, nc.uid, nc.money, nc.state, nc.get_type, nc.fetch_time, nc.use_time, nc.start_time, nc.end_time, nct.coupon_name, nct.at_least, nct.range_type, nct.term_of_validity_type, nct.fixed_term')->where($condition)->order('nc.start_time')->select();
