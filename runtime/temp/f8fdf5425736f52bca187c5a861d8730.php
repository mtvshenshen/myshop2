	...
	<dl>
		...
		<dd>
			<div class="upload-btn-common">
				...
				<img id="preview_default_goods_img" src="/public/static/blue/img/upload-common-select.png" <?php if($info['value']['default_goods_img']): ?>data-src="<?php echo __IMG($info['value']['default_goods_img']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
	...
	<dl>
		...
		<dd>
			<div class="upload-btn-common">
				...
				<img id="preview_default_headimg" src="/public/static/blue/img/upload-common-select.png" <?php if($info['value']['default_headimg']): ?>data-src="<?php echo __IMG($info['value']['default_headimg']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
	...
	<dl>
		...
		<dd>
			<div class="upload-btn-common">
				...
				<img id="preview_default_cms_thumbnail" src="/public/static/blue/img/upload-common-select.png" <?php if($info['value']['default_cms_thumbnail']): ?>data-src="<?php echo __IMG($info['value']['default_cms_thumbnail']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
	...
	<dl>
		...
		<dd>
			<div class="upload-btn-common">
				...
				<img id="preview_default_watermark" src="/public/static/blue/img/upload-common-select.png" <?php if($water_info['imgWatermark']): ?>data-src="<?php echo __IMG($water_info['imgWatermark']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/pictureSetting'); ?>",
		data : {
		...
		success : function(data){
			if(data['code'] > 0){
				...
				location.href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/pictureUploadSetting'); ?>";
			}else{
...
function selectConfig(){
	...
	if(flag){
		$.ajax({
			type:"post",
			url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/setUploadType'); ?>",
			data : { "type" : type },
			success : function(data){
				if(data['code'] > 0){
					showTip(data.message,"success");
