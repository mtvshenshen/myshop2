...
<div class="set-style">
	...
	<dl>
		...
		<dd>
			<div class="upload-btn-common">
				<div>
					<input class="input-file" name="file_upload" id="uploadImg" type="file" onchange="imgUpload(this, 'logo');" title="上传">
				...
				<img id="preview_logo" src="/public/static/blue/img/upload-common-select.png" <?php if($website['logo']): ?>data-src="<?php echo __IMG($website['logo']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
	...
	<dl>
		...
		<dd>
			...
			<div class="upload-btn-common">
				<div>
					<input class="input-file" name="file_upload" id="uploadImgwechat_share_logo" type="file" onchange="imgUpload(this, 'wechat_share_logo');" title="上传">
				...
				<img id="preview_wechat_share_logo" src="/public/static/blue/img/upload-common-select.png" <?php if($website['web_wechat_share_logo']): ?>data-src="<?php echo __IMG($website['web_wechat_share_logo']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
	...
	<dl>
		...
		<dd>
			<div class="upload-btn-common">
				...
				<img id="preview_qrcode_path" style="margin:0;" src="/public/static/blue/img/upload-common-select.png" data-src="<?php echo __IMG($qrcode_path); ?>" data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
			</div>
		</dd>
	</dl>
	...
	<dl>
		...
		<dd>
			...
			<div class="upload-btn-common">
				<div>
					<input class="input-file" name="file_upload" id="uploadImgweb_qrcode" type="file" onchange="imgUpload(this, 'web_qrcode');" title="上传">
				...
				<img id="preview_web_qrcode" src="/public/static/blue/img/upload-common-select.png" <?php if($website['web_qrcode']): ?>data-src="<?php echo __IMG($website['web_qrcode']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
...
function setConfigAjax() {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/webconfig'); ?>",
		data : {
			'title' : title,
			'web_url' : web_url,
...
// 			'web_style_pc' : web_style_pc,
		...
		success : function(data) {
			if (data["code"] > 0) {
				...
				window.location.href = "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/webconfig'); ?>";
			} else {
				showTip(res.message,"error");
			}
		}
