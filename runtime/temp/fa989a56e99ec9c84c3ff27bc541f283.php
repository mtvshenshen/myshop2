...
<div class="set-style">
	...
	<dl>
		<dt>排序：</dt>
		<dd>
			<p><input id="sort" type="number" value="<?php echo $module_info['sort']; ?>" class="input-common harf"></p>
	...
	<dl>
		...
		<dd>
			<div class="upload-btn-common">
				...
				<input type="text" id="text_Logo" class="input-common" readonly="readonly" value="<?php echo $module_info['module_picture']; ?>">
				<em>上传</em>
				<img id="preview_Logo" src="/public/static/blue/img/upload-common-select.png" data-src="<?php echo __IMG($module_info['module_picture']); ?>" data-html="true" data-container="body" data-placement="top" data-trigger="manual" data-original-title="" title="">
			</div>
	...
	<dl>
		<dt>描述：</dt>
		<dd>
			<p><textarea id="desc" class="textarea-common"><?php echo $module_info['desc']; ?></textarea></p>
...
function editModuleAjax() {
	...
	if(verify(module_name, controller, method, url, sort, desc)){
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/system/editmodule'); ?>",
			data : {
				'module_id' : module_id,
				'pid' : pid,
			...
			success : function(data) {
				if (data["code"] > 0) {
					...
					location.href = "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/system/modulelist'); ?>";
				}else{
