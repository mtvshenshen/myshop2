<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:37:"template/admin\Order\orderAction.html";i:1553512517;}*/ ?>
<style>
...
$(function() {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/getprovince'); ?>",
		dataType : "json",
...
function operation(operation_type, order_id){
	if(operation_type == 'pay'){
		...
		receivedPayment(order_id); // 货到付款订单已收到货款
	}
}
...
function orderDelivery(order_id){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/orderdeliverydata'); ?>",
		...
		success : function(data) {
			...
			for(var i=0;i<data['order_goods_list'].length;i++){
				...
				go_html += '<td><a href="'+__URL('http://127.0.0.1:8080/index.php/goods/detail?goods_id='+data['order_goods_list'][i]['goods_id'])+'" target="_blank"><img src="'+__IMG(data['order_goods_list'][i]['picture_info']['pic_cover_micro'])+'" style="width:40px;" title="'+data['order_goods_list'][i]['goods_name']+'"></a></td>';
				go_html += '<td style="text-align:left;"><a href="'+__URL('http://127.0.0.1:8080/index.php/goods/detail?goods_id='+data['order_goods_list'][i]['goods_id'])+'" target="_blank">'+data['order_goods_list'][i]['goods_name'];
...
function orderDeliverySubmit(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/orderdelivery'); ?>",
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				$.ajax({
					type : "post",
					url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/orderofflinepay'); ?>",
					data : {'order_id':order_id},
					success : function(data) {
						if (data["code"] > 0) {
							showMessage('success', data["message"],window.location.reload());
...
function orderComplete(order_id){
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/ordercomplete'); ?>",
		data : {'order_id':order_id},
		success : function(data) {
			if (data["code"] > 0) {
				showMessage('success', data["message"],window.location.reload());
...
function orderClose(order_id){
	$( "#dialog" ).dialog({
		buttons: {
			...
			$.ajax({
				type : "post",
				url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/orderclose'); ?>",
				data : {"order_id" : order_id},
				success : function(data) {
					if(data["code"] > 0 ){
						LoadingInfo(1);
...
function modifyPrice(order_id,orderFreight){
	...
	$.ajax({
		type: "post",
		url: "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/getordergoods'); ?>",
		data: { "order_id": order_id },
		dataType: "json",
		async: false,
		success: function (jsonData) {
			...
			for (var i = 0 ; i < jsonData.length; i++) {
				...
				str += "<a class='name' href="+__URL('http://127.0.0.1:8080/index.php/wap?id='+jsonData[i].goods_id)+" target='_blank'>" + jsonData[i].goods_name + "</a>";
				...
				str += "</td>"; 
					...
					if (i == 0) {
						if(order_info.is_virtual == 0){
							str += "<td rowspan='"+jsonData.length+"' class='hide'>";
...
function updPrice(){
	...
	$.ajax({
		type: "post",
		url: "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/orderadjustmoney'); ?>",
...
function orderSellerMemo(order_id){
	$.ajax({
		type : 'post',
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/getordersellermemo'); ?>",
		data : { "order_id" : order_id },
...
function orderPickupSubmit(){
	...
	$.ajax({
		type: "post",
		url: "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/pickuporder'); ?>",
...
function update_address(order_id){
	$.ajax({
		type : 'post',
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/getOrderUpdateAddress'); ?>",
		data : { "order_id" : order_id },
		success : function(data){
...
function updateAddressSubmit(){
	...
	$.ajax({
		type : 'post',
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/updateOrderAddress'); ?>",
		data : {
			"order_id" : order_id,
...
function GetProvince() {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/getcity'); ?>",
		dataType : "json",
		data : {
			"province_id" : id
		},
...
function getSelCity() {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/getdistrict'); ?>",
		dataType : "json",
		data : {
			"city_id" : id
		},
...
function addMemoAjax(){
	...
	$.ajax({
		url: "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/addmemo'); ?>",
...
function getdelivery(order_id){
	$.ajax({
		url: "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/orderTakeDelivery'); ?>",
		data: { "order_id": order_id },
		type : "post",
		success: function(data) {
			if (data.code > 0) {
...
function delete_order(order_id){
	$( "#dialog" ).dialog({
		buttons: {
			...
			$.ajax({
				type : "post",
				url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/deleteOrder'); ?>",
				...
				success : function(data) {
					if(data["code"] > 0 ){
						if(typeof LoadingInfo !="undefined"){
							...
							showMessage('success', data["message"], "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/orderlist'); ?>");
						}
					}
				}
			});
...
function updateExpressAjax(){
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/updateOrderExpress'); ?>",
...
function o2o_delivery(order_id){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/o2odeliverydata'); ?>",
		data : {'order_id':order_id},
		success : function(data) {
			$("#delivery_order_id").val(order_id);
			var receiver_info = '收货信息：'+data['order_info']['address']+'&nbsp;'+data['order_info']['receiver_address']+'&nbsp;'+data['order_info']['receiver_name']+'&nbsp;'+data['order_info']['receiver_mobile'];//收货信息
...
function o2oDeliverySubmit(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/o2odelivery'); ?>",
		data : {
			'order_id':order_id,
...
function received_payment(order_id){
	$( "#dialog" ).dialog({
		buttons: {
			...
			$.ajax({
				type : "post",
				url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/receivedPayment'); ?>",
				data : {"order_id" : order_id},
				success : function(data) {
					if(data["code"] > 0 ){
						LoadingInfo(1);
