...
<script src="/template/admin/public/js/My97DatePicker/WdatePicker.js" type="text/javascript"></script>
<style type="text/css">
...
<div class="set-style">
	...
	<dl>
		...
		<dd>
			<input type="number" id="level" class="input-common">
	...
	<dl>
		...
		<dd class="total">
			<div>
				升级送积分&nbsp;&nbsp;&nbsp;
				<input class="input-common harf" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" type="number" min="0" id="give_point" style="margin-bottom: 0px; " placeholder="0"><em class="unit">积分</em>
			</div>
			<div>
				升级送余额&nbsp;&nbsp;&nbsp;
				<input class="input-common harf" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" type="number" min="0" id="give_money" style="margin-bottom: 0px; " placeholder="0"><em class="unit">元</em>
			</div>
...
function save(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __url('http://127.0.0.1:8080/index.php/admin/member/addmemberlevel'); ?>",
		data : {
		...
		success : function(data) {
			if (data["code"] > 0) {
				...
				location.href="<?php echo __url('http://127.0.0.1:8080/index.php/admin/member/memberlevellist'); ?>";
			}else{
...
function addCoupon(){
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/sendcoupontypelist'); ?>",
		success : function(data) {
