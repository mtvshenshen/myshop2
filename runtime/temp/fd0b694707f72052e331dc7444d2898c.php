...
<div class="set-style">
	...
	<dl>
		...
		<dd>
			...
			<p class="hint">如开启邮箱和手机注册，请在<a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/notifyindex'); ?>" target="_blank">通知系统</a>功能中进行邮箱与短信通知配置，游客在注册时通过验证后方能注册成功</p>
		</dd>
	</dl>
	<dl>
		<dt>后台验证码是否开启：</dt>
	...
	<dl>
		<dt>错误多次后显示：</dt>
		<dd>
			<input type="number" class="input-common short" value="<?php echo $code_config['error_num']; ?>" id="error_num"><em class="unit">次</em>	
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/registerandvisit'); ?>",
		data : {
		...
		success : function(data){
			if(data['code'] > 0){
				...
				window.location.href = "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/registerandvisit'); ?>";
			}else{
