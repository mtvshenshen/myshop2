...
<!-- 					{1/block} -->
	...
	<div class="options-btn">
		...
		<button class="btn-common btn-big" onclick="emptyTemplateId()">清空</button>
	</div>
	...
	function changeIsEnable(id, event){
		...
		$.ajax({
			url : '<?php echo __URL('http://127.0.0.1:8080/index.php/NsWxtemplatemsg/admin/TempMsg/changeIsEnable'); ?>',
			type : 'post',
	...
	function getTemplateId(){
		$.ajax({
			url : '<?php echo __URL('http://127.0.0.1:8080/index.php/NsWxtemplatemsg/admin/TempMsg/getTemplateId'); ?>',
			type : 'get',
			success : function (data){
				if(data['code'] == 1){
	...
	function emptyTemplateId(){
		$.ajax({
			url : '<?php echo __URL('http://127.0.0.1:8080/index.php/NsWxtemplatemsg/admin/TempMsg/emptyTemplateId'); ?>',
			type : 'get',
			success : function (data){
				if(data['code'] > 0){
