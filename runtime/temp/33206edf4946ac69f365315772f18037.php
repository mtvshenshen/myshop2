...
<div class="set-style">
	<dl>
		...
		<dd>
			<div class="controls">
				<p>
					<input id="is_open_api_secure" type="checkbox" class="checkbox" <?php if($api_secure['is_open_api_secure'] == 1): ?>checked<?php endif; ?> />
				</p>
			</div>
	...
	<dl>
		<dt>秘钥：</dt>
		<dd>
			<input id="private_key" type="text" value="<?php echo $api_secure['private_key']; ?>" class="input-common" />
		</dd>
	</dl>
	<dl>
		<dt></dt>
...
function save() {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/apisecure'); ?>",
		data : {
			data : JSON.stringify({
