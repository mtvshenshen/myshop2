...
function setConfigAjax() {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/visitconfig'); ?>",
		data : {
		...
		success : function(data) {
			if (data["code"] > 0) {
				...
				window.location.href = "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/visitconfig'); ?>";
			} else {
