...
<div class="set-style wechat">
	<h4 class="first"><span></span>微信设置</h4>
	<div class="flex-wrap">
		<a class="block-diy" title="公众号设置" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/wchat/config'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-wchat.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">公众号设置</p>
					<p class="diy-desc">设置公众号快捷键</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="小程序设置" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/wchat/appletConfig'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-wchatapp.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">小程序设置</p>
					<p class="diy-desc">设置小程序快捷键</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="菜单设置" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/wchat/menu'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-menu.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">菜单设置</p>
					<p class="diy-desc">设置公众号菜单快捷键</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="关注设置" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/wchat/keyConcernConfig'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-attention.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">关注设置</p>
					<p class="diy-desc">设置一键关注快捷键</p>
				</div>
			</div>
		</a>
	...
	<h4><span></span>微信消息</h4>
	<div class="flex-wrap">
		<a class="block-diy" title="消息素材" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/wchat/materialmessage'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-material.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">消息素材</p>
					<p class="diy-desc">设置消息素材快捷键</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="关注回复" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/wchat/replayConfig?type=1'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-attention-reply.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">关注回复</p>
					<p class="diy-desc">设置关注回复快捷键</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="关键词回复" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/wchat/replayConfig?type=2'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-text-reply.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">关键词回复</p>
					<p class="diy-desc">设置关键词回复快捷键</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="默认回复" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/wchat/replayConfig?type=3'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-default-reply.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">默认回复</p>
					<p class="diy-desc">设置默认回复快捷键</p>
				</div>
			</div>
		</a>
	</div>	
	
	<h4><span></span>微信推广</h4>
	<div class="flex-wrap">
		<a class="block-diy" title="推广关注" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/wchat/weixinqrcodetemplate?type=1'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-promotion.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">推广关注</p>
					<p class="diy-desc">设置推广关注快捷键</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="推广店铺" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/wchat/weixinqrcodetemplate?type=2'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-shop.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">推广店铺</p>
					<p class="diy-desc">设置推广店铺快捷键</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="推广商品" href = ''>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-goods.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">推广商品</p>
					<p class="diy-desc">设置推广商品快捷键</p>
				</div>
			</div>
		</a>
	</div>
	...
	<h4><span></span>微信分享</h4>
	<div class="flex-wrap">
		<a class="block-diy" title="首页分享" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/wchat/shareconfig?type=3'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-qrcode.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">首页分享</p>
					<p class="diy-desc">设置首页分享快捷键</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="商品分享" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/wchat/shareconfig?type=2'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-goods-share.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">商品分享</p>
					<p class="diy-desc">设置商品分享快捷键</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="关注分享" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/wchat/shareconfig?type=1'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/wchat-icon-share.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">关注分享</p>
					<p class="diy-desc">设置关注分享快捷键</p>
				</div>
			</div>
		</a>
	</div>
