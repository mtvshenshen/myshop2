...
function set_status(event){
	$('.set-style').find('img').attr('src', '/template/admin/public/images/un_checked.png');
...
function setMemberwithdrawAjax() {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/customservice'); ?>",
		data : {
