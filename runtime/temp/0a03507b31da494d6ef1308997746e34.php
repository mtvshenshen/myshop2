...
<link rel="stylesheet" type="text/css" href="/template/admin/public/css/member_detail.css" />
...
<div class="set-style">
	...
	<dl>
		...
		<dd>
			<div class="member-img">
				<?php if($member_detail['user_info']['user_headimg']): ?>
					<img src="<?php echo __IMG($member_detail['user_info']['user_headimg']); ?>">
				<?php else: ?>
	...
	<dl>
		<dt>用户名：</dt>
		<dd>
			<?php if($member_detail['member_name']): ?><?php echo $member_detail['member_name']; else: ?>--<?php endif; ?>
		</dd>
	</dl>
	<dl>
		<dt>等级：</dt>
		<dd>
			<?php if($member_detail['level_name']): ?><?php echo $member_detail['level_name']; else: ?>--<?php endif; ?>
		</dd>
	</dl>
	<dl>
		<dt>积分：</dt>
		<dd>
			<?php echo $member_detail['point']; ?>
		</dd>
	</dl>
	<dl>
		<dt>余额：</dt>
		<dd>
			<?php echo $member_detail['balance']; ?>
		</dd>
	</dl>
	<dl>
		<dt>标签：</dt>
		<dd>
			<?php if($member_detail['label_name']): ?><?php echo $member_detail['label_name']; else: ?>--<?php endif; ?>
		</dd>
	</dl>
	<dl>
		<dt>最后登录：</dt>
		<dd>
			<?php if($member_detail['user_info']['current_login_time']): ?><?php echo date('Y-m-d H:i:s',$member_detail['user_info']['current_login_time']); else: ?>--<?php endif; ?>
		</dd>
	</dl>
	...
	<dl>
		<dt>昵称：</dt>
		<dd>
			<?php if($member_detail['user_info']['nick_name']): ?>
			<?php echo $member_detail['user_info']['nick_name']; else: ?>--<?php endif; ?>
		</dd>
	</dl>
	<dl>
		<dt>标签：</dt>
	...
	<dl>
		...
		<dd>
			...
			<?php echo $member_detail['user_info']['user_tel']; else: ?>--<?php endif; ?>
		</dd>
	</dl>
	<dl>
		<dt>性别：</dt>
		<dd>
			<?php if($member_detail['user_info']['sex'] == 1): ?>
				<span>男</span>
			<?php elseif($member_detail['user_info']['sex'] == 2): ?>
				<span>女</span>
			<?php else: ?>
				<span>保密</span>
			<?php endif; ?>
	...
	<dl>
		...
		<dd>
			...
			<span><?php echo $member_detail['user_info']['user_email']; ?></span>
			<?php else: ?>
			<span>--</span>
			<?php endif; ?>
		</dd>
	...
	<dl>
		<dt>QQ：</dt>
		<dd>
			<?php if($member_detail['user_info']['user_qq']): ?>
			<span><?php echo $member_detail['user_info']['user_qq']; ?></span>
			<?php else: ?>
			<span>--</span>
			<?php endif; ?>
		</dd>
	...
	<div class="member-order">
			<div>
				<div class="member-fileds-info">
					<span>累计消费：</span>
					<span>￥<?php echo $member_detail['order_money']; ?></span>
				</div>
				<div class="member-fileds-info">
					<span>消费次数：</span>
					<span><?php echo $member_detail['order_count']; ?></span>
				</div>
				<div class="member-fileds-info">
					<span>平均消费金额：</span>
					<span>￥<?php echo $member_detail['avg_order_money']; ?></span>
				</div>
				<div class="member-fileds-info">
					<span>最近消费时间：</span>
					<?php if($member_detail['last_pay_time']): ?>
					<span><?php echo date('Y-m-d H:i:s',$member_detail['last_pay_time']); ?></span>
					<?php else: ?>
					<span>--</span>
					<?php endif; ?>
				</div>
