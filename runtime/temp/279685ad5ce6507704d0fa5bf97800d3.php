		...
		<tr>
			<td>
				<div class="table-logo">
					<?php if($k == 2): ?>
					<img src="/template/admin/public/images/ali.png" >
					<?php else: ?>
					<img src="/template/admin/public/images/mail.png">
					<?php endif; ?>
				</div>
				<span class="table-pay"><?php echo $notify_obj['notify_name']; ?></span>
				<?php if($k == 2): ?>
			...
			<td style="text-align: center;line-height:59px;margin-left:0px;"  class="is_use_<?php echo $notify_obj['id']; ?>">
				<img src="/template/admin/public/images/checked.png" alt="" width="18"/></td>
			</td>
			<?php else: ?>
			...
			<td style="text-align: center;">
					...
					<span>
						<a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/messageconfig'); ?>">配置</a></span>
					<?php else: ?>
						<span><a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/smsconfig'); ?>">配置</a></span>
					<?php endif; if($notify_obj['key'] == 'EMAILMESSAGE'): ?>
					<span><a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/notifytemplate','type=email'); ?>">模板</a></span>
					<?php else: ?>
					<span><a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/notifytemplate','type=sms'); ?>">模板</a></span>
					...
					<br/>
					<?php if($notify_obj['key'] == 'EMAILMESSAGE'): ?>
					<span><a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/businessnotifytemplate','type=email'); ?>">商家通知</a></span>
					<span><a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/notifylist','type=2'); ?>">通知记录</a></span>
					<?php else: ?>
					<span><a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/businessnotifytemplate','type=sms'); ?>">商家通知</a></span>
					<span><a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/notifylist','type=1'); ?>">通知记录</a></span>
					<?php endif; ?>
			</td>
		</tr>
		<?php endforeach; endif; else: echo "" ;endif; ?>
...
function setIsUse(id,value){
	...
	$.ajax({
		type : "post",
		url: "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/updatenotifyenable'); ?>",
		data: { "id": id, "is_use": is_use },
		async : false, // 让它同步执行
		success: function (data) {
			if (data["code"] > 0) {
				showTip('提交成功','success');
				window.location.href=__URL("http://127.0.0.1:8080/index.php/admin/config/notifyindex");
			}else{
				showTip('提交成功','success');
			}
		}
