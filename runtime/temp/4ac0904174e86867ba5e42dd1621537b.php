...
<link rel="stylesheet" type="text/css" href="/template/admin/public/css/wap_template.css">
<style>
.mlr15{margin:0;}
...
.app-template{padding:20px;}
.app-template li{width:220px;}
.edit_button{margin: 12px auto;padding: 3px 10px;border: 0;background: #00A0DE;color: #fff;width:100px;height:35px;}
	...
	<dl class="wap-template-box">
		<dd>
			<div class="wap-template-list">
				...
				<div class="wap-template-item" data-folder="<?php echo $template['folder']; ?>">
					<div class="wap-template-img"><img alt="" src="/template/wap/<?php echo $template['folder']; ?>/<?php echo $template['preview']; ?>"></div>
					<div class="wap-template-text">
						<div class="wap-template-name"><?php echo $template['introduce']; ?></div>
						<div class="wap-template-state">
							<div class="wap-template-introduce"><?php echo $template['theme']; ?></div>
							<?php if($template['folder']==$use_template): ?>
...
function chagecategoryblock(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/iscategory'); ?>",
...
$(".wap-template-item").click(function(){
	$.ajax({
		type : "post",
		url :  "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/Config/updateTemplateUse'); ?>",
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/updateWapBasicInformation'); ?>",
