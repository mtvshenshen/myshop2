...
<div class="set-style">
	<dl>
		...
		<dd>
			<input type="text" id="label_name" class="input-common" value="<?php echo $info['label_name']; ?>">
	...
	<dl>
		<dt>标签描述：</dt>
		<dd>
			<textarea id="desc" class="textarea-common"><?php echo $info['desc']; ?></textarea>
...
function save(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __url('http://127.0.0.1:8080/index.php/admin/member/editmemberlabel'); ?>",
		data : {
			id : id,
		...
		success : function(data) {
			if (data["code"] > 0) {
				...
				location.href="<?php echo __url('http://127.0.0.1:8080/index.php/admin/member/memberlabellist'); ?>";
			}else{
