...
<link rel="stylesheet" type="text/css" href="/template/admin/public/css/promotion_block.css">
...
<div class="set-style">
	<h4 class="first"><span></span>店铺营销</h4>
	<div class="flex-wrap">
		<a class="block-diy" title="优惠券" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/coupontypelist'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-coupon.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">优惠券</p>
					<p class="diy-desc">设置商城优惠券</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="积分抵现" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/pointconfig'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-point.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">积分抵现</p>
					<p class="diy-desc">设置积分抵现相关</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="赠品" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/giftlist'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-gift.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">赠品</p>
					<p class="diy-desc">设置购买商品赠品</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="满减送" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/mansonglist'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-manjian.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">满减送</p>
					<p class="diy-desc">设置满减送优惠</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="限时折扣" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/getdiscountlist'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-discount.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">限时折扣</p>
					<p class="diy-desc">设置商品显示折扣</p>
				</div>
			</div>
		</a>
		<?php if(addon_is_exit('NsCombopackage')): ?>
		<a class="block-diy" title="组合套餐" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/NsCombopackage/admin/Promotion/comboPackagePromotionList'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-package.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">组合套餐</p>
					<p class="diy-desc">设置商品套餐</p>
				</div>
			</div>
		</a>
		<?php endif; ?>
		<a class="block-diy" title="满额包邮" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/fullshipping'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-shipping.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">满额包邮</p>
					<p class="diy-desc">设置满额包邮</p>
				</div>
			</div>
		</a>
		<?php if(addon_is_exit('NsPintuan')): ?>
		<a class="block-diy" title="拼团" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/NsPintuan/admin/tuangou/pintuanlist'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-pintuan.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">拼团</p>
					<p class="diy-desc">设置拼团活动相关</p>
				</div>
			</div>
		</a>
		<?php endif; if(addon_is_exit('NsBargain')): ?>
		<a class="block-diy" title="砍价" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/NsBargain/admin/bargain/index'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-bargain.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">砍价</p>
					<p class="diy-desc">设置砍价活动相关</p>
				</div>
			</div>
		</a>
		<?php endif; if(addon_is_exit('NsPresell')): ?>
		<a class="block-diy" title="预售" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/order/orderlist?order_type=6'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-presale.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">预售</p>
					<p class="diy-desc">设置商品预售</p>
				</div>
			</div>
		</a>
		<?php endif; ?>
		<a class="block-diy" title="专题活动" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/topiclist'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-topic.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">专题活动</p>
					<p class="diy-desc">设置商城专题活动</p>
				</div>
			</div>
		</a>
		<?php if(addon_is_exit('NsGroupBuy')): ?>
		<a class="block-diy" title="团购" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/NsGroupBuy/admin/promotion/groupBuyList'); ?>'>
			<div class="diy-content"> 
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-tuangou.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">团购</p>
					<p class="diy-desc">设置商城团购活动</p>
				</div>
			</div>
		</a>
		<?php endif; ?>
	...
	<h4><span></span>会员营销</h4>
	<div class="flex-wrap">
		<a class="block-diy" title="注册" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/integral?type=1'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-registered.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">注册</p>
					<p class="diy-desc">设置注册奖励规则</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="签到" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/integral?type=2'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-sign-in.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">签到</p>
					<p class="diy-desc">设置签到奖励规则</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="分享" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/integral?type=3'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-share.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">分享</p>
					<p class="diy-desc">设置分享奖励规则</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="点赞" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/integral?type=4'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-zan.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">点赞</p>
					<p class="diy-desc">设置点赞奖励规则</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="评论" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/integral?type=5'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-comment.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">评论</p>
					<p class="diy-desc">设置评论奖励规则</p>
				</div>
			</div>
		</a>
	</div>	
	
	<h4><span></span>互动游戏</h4>
	<div class="flex-wrap">
		<a class="block-diy" title="互动游戏" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/promotiongameslist?type=8'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-turntable.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">大转盘</p>
					<p class="diy-desc">设置大转盘活动</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="互动游戏" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/promotiongameslist?type=3'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-scratch.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">刮刮乐</p>
					<p class="diy-desc">设置刮刮乐活动</p>
				</div>
			</div>
		</a>
		<a class="block-diy" title="互动游戏" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/promotiongameslist?type=7'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/icon-promotion-golden-egg.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">砸金蛋</p>
					<p class="diy-desc">设置砸金蛋活动</p>
				</div>
			</div>
		</a>
	</div>
