	...
	<ul class="basic_data_ons_son_list">
        <li>
            <div class="basic_data_ons_son_list_nvs">
                <p>本月支付金额</p>
				<cite><?php echo $base_data['month_money']['data']['pay_money']; ?></cite>
			</div>
		</li>
		<li>
			<div class="basic_data_ons_son_list_nvs">
                <p>本月利润</p>
				<cite><?php echo $base_data['month_money']['data']['profit']; ?></cite>
			</div>
		</li>
		<li>
			<div class="basic_data_ons_son_list_nvs">
                <p>支付总额</p>
				<cite><?php echo $base_data['money']['pay_money']; ?></cite>
			</div>
		</li>
		<li>
			<div class="basic_data_ons_son_list_nvs">
                <p>总利润</p>
				<cite><?php echo $base_data['money']['profit']; ?></cite>
			</div>
		</li>
	</ul>
</div>
	...
	<div class="survey-data">
		<ul>
			<li>
				...
				<span class="trend">较前一日 <em class="<?php echo $base_data['today_data']['order_num']['trend']; ?>"><?php echo $base_data['today_data']['pay_money']['ratio']; ?>%</em></span>
			</li>
			<li>
				<h4 class="item-name">利润</h4>
				<span class="item-value"><?php echo $base_data['today_data']['profit']['value']; ?></span>
				<span class="trend">较前一日 <em class="<?php echo $base_data['today_data']['profit']['trend']; ?>"><?php echo $base_data['today_data']['profit']['ratio']; ?>%</em></span>
			</li>
		</ul>
	</div>
</div>
