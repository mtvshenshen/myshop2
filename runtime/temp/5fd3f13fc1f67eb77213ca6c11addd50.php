...
<div class="set-style">
	...
	<div class="set-item <?php if($type != 1): ?> hide <?php endif; ?>">
		<dl>
			<dt>会员注册送积分：</dt>
			<dd>
	...
	<div class="set-item <?php if($type != 2): ?> hide <?php endif; ?>">
		<dl>
			<dt>签到送积分：</dt>
			<dd>
	...
	<div class="set-item <?php if($type != 3): ?> hide <?php endif; ?>">
		<dl>
			<dt>分享送积分：</dt>
			<dd>
	...
	<div class="set-item <?php if($type != 4): ?> hide <?php endif; ?>">
		<dl>
			<dt>点赞送积分：</dt>
			<dd>
	...
	<div class="set-item <?php if($type != 5): ?> hide <?php endif; ?>">
		<dl>
			<dt>评论送积分：</dt>
			<dd>
...
function setIntegralAjax(){
	...
	$.ajax({
		type : 'post',
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/setintegralajax'); ?>",
		data : {
			'register':register,
			'sign':sign,
			'share':share,
...
function setRewardRuleAjax(){
	...
	$.ajax({
		type : 'post',
		url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/integral'); ?>",
		data : {
		...
		success : function(data){
			if(data['code'] >=0){
				showMessage("success", "设置成功！", "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/promotion/memberpromotion'); ?>");
			}else{
