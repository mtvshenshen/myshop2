...
<style>
	...
	.block-diy  .diy-content .diy-icon{
		flex: none;
		height: 40px;
		width: 40px;
		line-height:42px;
	...
	.block-diy  .diy-content .diy-info{
		margin-left: 10px;
	}
	.block-diy  .diy-content .diy-info .diy-title{
		height: 24px;
		line-height: 25px;
		margin: 0;
		font-size: 14px;
	...
	.block-diy  .diy-content .diy-info .diy-desc{
		color: #aaa;
		font-size: 12px;
		font-weight: 400;
		margin: 0;
...
<div class="set-style">
	<h4 class="first"><span></span>电脑端装修</h4>
	<div class="flex-wrap">
			
		<a class="block-diy" title="模板选择" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/pctemplate'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-pc-icon-template.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">模板选择</p>
					<p class="diy-desc">设置电脑端模板</p>
				</div>
			</div>
		</a>
		
		<a class="block-diy" title="导航设置" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/shopnavigationlist?nav_type=1'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-pc-icon-navigation.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">导航设置</p>
					<p class="diy-desc">设置电脑端顶部导航菜单</p>
				</div>
			</div>
		</a>
		
		<a class="block-diy" title="商品楼层" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/block/goodsFloorBlock'); ?>">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-pc-icon-floor.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">商品楼层</p>
					<p class="diy-desc">设置电脑端首页楼层板块</p>
				</div>
			</div>
		</a>
		
		<a class="block-diy" title="热门搜索" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/searchConfig?type=hot'); ?>">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-pc-icon-hot.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">热门搜索</p>
					<p class="diy-desc">设置搜索栏热门关键字</p>
				</div>
			</div>
		</a>
		
		<a class="block-diy" title="默认搜索" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/searchConfig?type=default'); ?>">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-pc-icon-default.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">默认搜索</p>
					<p class="diy-desc">设置搜索栏默认搜索关键字</p>
				</div>
			</div>
		</a>
		
		<a class="block-diy" title="广告管理" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/system/shopadvpositionlist?terminal=1'); ?>">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-pc-icon-adv.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">广告管理</p>
					<p class="diy-desc">设置电脑端广告页面</p>
				</div>
			</div>
		</a>
		
		<a class="block-diy" title="商家服务" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/merchantService'); ?>">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-pc-icon-service.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">商家服务</p>
					<p class="diy-desc">设置电脑端底部商家服务功能</p>
				</div>
			</div>
		</a>
		
		<a class="block-diy" title="SEO设置" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/seoConfig'); ?>">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-pc-icon-seo.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">SEO设置</p>
					<p class="diy-desc">设置SEO</p>
				</div>
			</div>
		</a>
		
		<a class="block-diy" title="版权设置" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/copyrightinfo'); ?>">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-pc-icon-copy.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">版权设置</p>
					<p class="diy-desc">设置网站底部版权（针对授权用户）</p>
				</div>
			</div>
		</a>
		
		<a class="block-diy" title="友情链接" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/linklist'); ?>">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-pc-icon-friend.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">友情链接</p>
					<p class="diy-desc">设置电脑端友情链接</p>
				</div>
			</div>
		</a>
	...
	<h4><span></span>手机端装修</h4>
		<div class="flex-wrap">
		<a class="block-diy" title="模板选择" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/fixedtemplate'); ?>' title="模板选择">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-wap-icon-template.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">模板选择</p>
					<p class="diy-desc">设置手机端模板</p>
				</div>
			</div>
		</a>
		
		<a class="block-diy" title="首页排版" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/pagelayout'); ?>">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-wap-icon-page-layout.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">首页排版</p>
					<p class="diy-desc">定制手机端首页排版</p>
				</div>
			</div>
		</a>
			
		<a class="block-diy" title="首页导航" href = '<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/shopNavigationList?nav_type=2'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-wap-icon-nav.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">首页导航</p>
					<p class="diy-desc">设置手机端中部导航菜单</p>
				</div>
			</div>
		</a>
		
<!-- 		<a class="block-diy" title="商品楼层" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/system/goodscategoryblock'); ?>"> -->
<!-- 			<div class="diy-content"> -->
<!-- 				<div class="diy-icon"> -->
<!-- 					<img src="/template/admin/public/images/diy-wap-icon-floor.png" alt="" /> -->
<!-- 				</div> -->
<!-- 				<div class="diy-info"> -->
<!-- 					<p class="diy-title">商品楼层</p> -->
<!-- 					<p class="diy-desc">设置手机端首页商品楼层板块</p> -->
<!-- 				</div> -->
<!-- 			</div> -->
<!-- 		</a> -->
		
		<a class="block-diy" title="分类显示" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/classifiedDisplayMode'); ?>">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-wap-icon-type.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">分类显示</p>
					<p class="diy-desc">设置手机端</p>
				</div>
			</div>
		</a>
		
		<a class="block-diy" title="广告管理" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/system/shopadvpositionlist?terminal=2'); ?>">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-wap-icon-adv.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">广告管理</p>
					<p class="diy-desc">设置手机端广告页面</p>
				</div>
			</div>
		</a>
		
		<a class="block-diy" title="商品推荐" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/goodsRecommend'); ?>">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-wap-icon-goods-recommand.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">商品推荐</p>
					<p class="diy-desc">设置商品推荐</p>
				</div>
			</div>
		</a>
		
		<!-- <a class="block-diy" title="首页魔方" href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/shopCube'); ?>">
			<div class="diy-content">
				<div class="diy-icon">
					<img src="/template/admin/public/images/diy-wap-icon-goods-cube.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">首页魔方</p>
					<p class="diy-desc">设置首页魔方</p>
				</div>
			</div>
		</a> -->
		
		<?php if(addon_is_exit('NsDiyView') == 1): ?>
		<a class="block-diy" title="微页面" href='<?php echo __URL('http://127.0.0.1:8080/index.php/NsDiyView/admin/config/wapcustomTemplateList'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img  src="/template/admin/public/images/diy-wap-icon-customize.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">微页面</p>
					<p class="diy-desc">手机端首页模板自定义设置</p>
				</div>
			</div>
		</a>
		<?php endif; ?>
		
		<a class="block-diy" title="底部导航" href='<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/wapBottomType'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img  src="/template/admin/public/images/diy-wap-icon-type-bottom.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">底部导航</p>
					<p class="diy-desc">手机端底部导航设置</p>
				</div>
			</div>
		</a>
		
		<a class="block-diy" title="页面风格" href='<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/wapStyle'); ?>'>
			<div class="diy-content">
				<div class="diy-icon">
					<img  src="/template/admin/public/images/diy-wap-icon-style.png" alt="" />
				</div>
				<div class="diy-info">
					<p class="diy-title">页面风格</p>
					<p class="diy-desc">手机端页面风格设置</p>
				</div>
			</div>
		</a>
