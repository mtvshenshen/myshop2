<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:41:"template/admin\Config\appWelcomePage.html";i:1552613507;s:48:"D:\phpStudy\WWW\niushop\template\admin\base.html";i:1553915410;s:65:"D:\phpStudy\WWW\niushop\template\admin\controlCommonVariable.html";i:1552613506;s:52:"D:\phpStudy\WWW\niushop\template\admin\urlModel.html";i:1552613544;s:71:"D:\phpStudy\WWW\niushop\template\admin\Promotion\goodsSelectDialog.html";i:1552613504;s:54:"D:\phpStudy\WWW\niushop\template\admin\pageCommon.html";i:1552613506;s:54:"D:\phpStudy\WWW\niushop\template\admin\openDialog.html";i:1552613504;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>停留时间：</dt>
		<dd>
			<input id="residence_time" type="number" min="0" step="1" onkeyup="value=value.replace(/[^\d+]/g,'')" value="<?php echo $info['residence_time']; ?>" class="input-common harf"><em class="unit">秒</em>
	...
	<dl>
		<dt>跳转链接：</dt>
		<dd>
			<input id="jump_link" type="text" value="<?php echo $info['jump_link']; ?>" class="input-common" />
		...
		<dd>
			<div class="upload-btn-common">
				<div>
					...
					<input type="hidden" id="welcome_page_picture" value="<?php if($info['welcome_page_picture']): ?><?php echo $info['welcome_page_picture']; endif; ?>" />
				</div>
				<input type="text" id="text_welcome_page_picture" class="input-common" readonly="readonly" value="<?php if($info['welcome_page_picture']): ?><?php echo $info['welcome_page_picture']; endif; ?>" />
				<em>上传</em>
				
				<img id="preview_welcome_page_picture" src="/public/static/blue/img/upload-common-select.png" <?php if($info['welcome_page_picture']): ?>data-src="<?php echo __IMG($info['welcome_page_picture']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
	...
	<span id="goods-condition">
		...
		<input type="hidden" id="goods_id_array" value="<?php echo $info['goods_id']; ?>">
		<?php if($info['goods_id']): ?>
...
function open_Goods_Select_List(){
	...
	layer_index = layer.open({
		...
		shade: 0.8,
		area: ['960px', '570px'],
		content: __URL('http://127.0.0.1:8080/index.php/admin/promotion/goodsSelectList?type=' + type + '&data=' + data + '&goods_id_array=' + goods_id_array),
	});
...
function save(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('http://127.0.0.1:8080/index.php/admin/config/appWelcomePage'); ?>",
