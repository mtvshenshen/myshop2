...
<table class="table-class">
	...
	<tbody>
		...
		<tr>
			<td>
				<div class="table-logo"><img src="/<?php echo $pay_obj['logo']; ?>"/></div>
			...
			<td style="text-align: center;line-height:59px;">
				<a href="<?php echo $pay_obj['url']; ?>">配置</a>
			</td>
		</tr>
		<?php endforeach; endif; else: echo "" ;endif; ?>
	</tbody>
