...
<link rel="stylesheet" href="/template/admin/public/css/plugin/tooltips.css">
<link rel="stylesheet" href="/template/admin/public/css/page_layout.css"/>
...
<div class="page-layout">
	<div class="preview">
		...
		<div class="iphone-header"><div class="iphone-title"></div></div>
		<div class="preview-body">
			<ul>
				<li v-for="(li,index) in data" v-bind:class="[ 'draggable-element',li.className,li.selected ? 'selected' : '' ]" v-on:click="clickModule(index)" v-bind:data-index="index" v-bind:data-sort="index"></li>
			</ul>
		</div>
		<div class="wrapper-footer"></div>
		<div class="form-group"><button class="btn-common btn-big" v-on:click="save">保存</button><button class="btn-common-cancle btn-big" v-on:click="reset">重置</button></div>
	</div>
</div>
...
<script>
var value = eval('<?php echo $value; ?>');
var ADMINMAIN = 'http://127.0.0.1:8080/index.php/admin';
</script>
<script src="/template/admin/public/js/vue.js"></script>
<script src="/template/admin/public/js/plugin/drag-arrange.js"></script>
<script src="/template/admin/public/js/plugin/jquery.pure.tooltips.js"></script>
<script src="/template/admin/public/js/page_layout.js"></script>
