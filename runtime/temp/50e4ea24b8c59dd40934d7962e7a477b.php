...
<table class="table-class">
	...
	<tr class="pid_0" style="height: 30px;">
		...
		<td style="text-align: center;">
			<a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/system/editmodule','module_id='.$v1['module_id']); ?>">修改</a>
		...
		<tr class="pid_<?php echo $v1['module_id']; ?>" style="height: 30px; display: none;">
			...
			<td style="text-align: center;">
				<a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/system/editmodule','module_id='.$v2['module_id']); ?>">修改</a>
			...
			<tr class="pid_<?php echo $v2['module_id']; ?> pid_<?php echo $v1['module_id']; ?>" style="height: 30px; display: none;">
				...
				<td style="text-align: center;">
					<a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/system/editmodule','module_id='.$v3['module_id']); ?>">修改</a>
				...
				<tr class="pid_<?php echo $v3['module_id']; ?> pid_<?php echo $v2['module_id']; ?> pid_<?php echo $v1['module_id']; ?>" style="height: 30px; display: none;">
					...
					<td style="text-align: center;">
						<a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/system/editmodule','module_id='.$v4['module_id']); ?>">修改</a>
					...
					<tr class="pid_<?php echo $v4['module_id']; ?> pid_<?php echo $v3['module_id']; ?> pid_<?php echo $v2['module_id']; ?> pid_<?php echo $v1['module_id']; ?>" style="height: 30px; display: none;">
						...
						<td style="text-align: center;">
							<a href="<?php echo __URL('http://127.0.0.1:8080/index.php/admin/system/editmodule','module_id='.$v5['module_id']); ?>">修改</a>
...
$(".table-class input").change(function(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('http://127.0.0.1:8080/index.php/admin/system/modifyfield'); ?>",
...
function addModule(){
	var pid = $("#pid").val();
	location.href = __URL("http://127.0.0.1:8080/index.php/admin/system/addmodule?pid="+pid);
}
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				...
				$.ajax({
					type:"post",
					url:"<?php echo __URL('http://127.0.0.1:8080/index.php/admin/system/delmodule'); ?>",
					data:{'module_id':module_id},
					dataType: 'json',
					success:function (data) {
						if(data['code'] > 0){
							showTip(data["message"],'success');
							location.href = __URL("http://127.0.0.1:8080/index.php/admin/system/modulelist");
						}else{
