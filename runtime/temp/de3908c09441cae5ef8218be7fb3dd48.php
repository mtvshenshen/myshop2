	...
	<dl>
		...
		<dd>
			<div class="upload-btn-common">
				...
				<em>上传</em>
				<img id="preview_Logo" src="/public/static/blue/img/upload-common-select.png" data-src="" data-html="true" data-container="body" data-placement="top" data-trigger="manual" data-original-title="" title="">
			</div>
...
function addModuleAjax() {
	...
	if(verify(module_name, controller, method, url, sort, desc)){
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('http://127.0.0.1:8080/index.php/admin/system/addmodule'); ?>",
			data : {
				'pid' : pid,
